  ...
  "../../node_modules/event-target-shim/dist/event-target-shim.js"(exports, module2) {
    ...
    function EventTarget() {
      ...
      if (arguments.length > 0) {
        const types6 = new Array(arguments.length);
        for (let i2 = 0; i2 < arguments.length; ++i2) {
          types6[i2] = arguments[i2];
        }
        return defineCustomEventTarget(types6);
      }
...
// ../utils/dist/utility-types.js
var require_utility_types = __commonJS({
  "../utils/dist/utility-types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
var require_types = __commonJS({
  "../utils/dist/types.js"(exports) {
    ...
    function isNotDefined(value) {
      return isNull(value) || (isString(value) ? value === "" || value.toLowerCase() === "null" || value.toLowerCase() === "undefined" : false);
    }
...
var require_guard = __commonJS({
  "../utils/dist/guard.js"(exports) {
    ...
    function isString(value, { name, strict = true, alpha, numeric }) {
      if ((strict || !types6.isNull(value)) && !types6.isString(value)) {
    ...
    function isEnumValue(value, enumeration, { name, strict = true }) {
      const values = new Set(Object.values(enumeration));
      if ((strict || !types6.isNull(value)) && !values.has(value)) {
        const list = Array.from(values, (value2) => JSON.stringify(value2)).join(", ");
        throw new Error(`IllegalArgument: ${name} must be one of [${list}]. Received ${value}`);
      }
    }
    exports.isEnumValue = isEnumValue;
    function isOneOf(value, values, { name, strict = true }) {
      if ((strict || !types6.isNull(value)) && !values.includes(value)) {
        const list = values.map((value2) => JSON.stringify(value2)).join(", ");
        throw new Error(`IllegalArgument: ${name} must be one of [${list}]. Received ${value}`);
      }
    }
    exports.isOneOf = isOneOf;
    function instanceOf(value, ctor, { name, strict = true }) {
      if ((strict || !types6.isNull(value)) && !types6.instanceOf(value, ctor)) {
        throw new Error(`IllegalType: ${name} must be an instance of ${ctor.name}`);
      }
    }
    exports.instanceOf = instanceOf;
    function custom(value, check, { name, strict = true, message }) {
      if ((strict || !types6.isNull(value)) && !check(value)) {
  ...
  "../utils/dist/general.js"(exports) {
    ...
    function shortid() {
      return "xxx".replace(/[x]/g, () => {
        const r2 = Math.random() * 36 | 0;
        return r2.toString(36);
      });
    }
    ...
    function sleep(ms) {
      if (types6.isNumber(ms)) {
        return new Promise((resolve) => setTimeout(resolve, ms));
      }
    }
    exports.sleep = sleep;
    function toJSON(object, props) {
      if (!types6.isObject(object))
        return object;
      if (types6.isArray(object)) {
        return object.map((value) => value && types6.isFunction(value.toJSON) ? value.toJSON() : toJSON(value));
      }
      const original = props ? Object.values(props) : Object.keys(object);
      const keys = !props || types6.isArray(props) ? original : Object.keys(props);
      return keys.reduce((plain, key, index) => {
        const value = object[original[index]];
        plain[key] = value && types6.isFunction(value.toJSON) ? value.toJSON() : toJSON(value);
        return plain;
      }, {});
    }
    ...
    function toUnAnchoredUri(url) {
      var _a4;
      const [, result = url] = (_a4 = url.match(/(^[^#]*)/)) !== null && _a4 !== void 0 ? _a4 : [];
    ...
    function toUriEncoding(url) {
      return url.replace(/(\\[0-9a-fA-F]{1,6}\s?)/g, (s2) => {
        return String.fromCodePoint(Number.parseInt(s2.substring(1).trim(), 16));
      });
    }
    exports.toUriEncoding = toUriEncoding;
    function removeUndefinedProps(object) {
      return Object.entries(object).reduce((object2, [key, value]) => value !== void 0 ? Object.assign(object2, { [key]: value }) : object2, {});
    }
    ...
    function cachify(func, getKey) {
      ...
      const funcWithCache = (...args) => {
        var _a4;
        const key = stringifyKey((_a4 = getKey === null || getKey === void 0 ? void 0 : getKey(args)) !== null && _a4 !== void 0 ? _a4 : args);
      ...
      function stringifyKey(key) {
        key = types6.isPlainObject(key) ? Object.fromEntries(Object.entries(key).sort(([key1], [key2]) => key1 > key2 ? 1 : -1)) : key;
    ...
    function batchify(func, { timeout }) {
      let pendingInputs = /* @__PURE__ */ new Map();
    ...
    function wrap(func, wrapper) {
      return new Proxy(func, {
        apply: (func2, _this, args) => wrapper(func2, ...args)
      });
    }
    exports.wrap = wrap;
    function extend(target, extension) {
      ...
      return Object.defineProperties(result, {
        ...
        ...Object.getOwnPropertyDescriptors(types6.isFunction(extension) ? extension(result) : extension)
      });
    }
    exports.extend = extend;
    function pluralize(object, config) {
      const count = types6.isArray(object) ? object.length : object;
...
// ../utils/dist/geometry.js
var require_geometry = __commonJS({
  "../utils/dist/geometry.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    var types6 = __importStar(require_types());
    var guard = __importStar(require_guard());
    function location(region2) {
      return { x: region2.x, y: region2.y };
    }
    exports.location = location;
    function size(region2) {
      return { width: region2.width, height: region2.height };
    }
    exports.size = size;
    function region(location2, size2) {
      if (!location2)
        location2 = { x: 0, y: 0 };
      return { x: location2.x, y: location2.y, width: size2.width, height: size2.height };
    }
    ...
    function round(target) {
      const result = { ...target };
      if (types6.has(target, ["x", "y"])) {
        result.x = Math.round(target.x);
        result.y = Math.round(target.y);
      }
      if (types6.has(target, ["width", "height"])) {
    ...
    function floor(target) {
      ...
      if (types6.has(target, ["width", "height"])) {
        result.width = Math.floor(target.width + (types6.has(target, "x") ? target.x - result.x : 0));
        result.height = Math.floor(target.height + (types6.has(target, "y") ? target.y - result.y : 0));
      }
      return result;
    }
    exports.floor = floor;
    function rotate(target, degrees, size2) {
      ...
      if (types6.has(target, ["x", "y"]) && size2) {
        const hasSize = types6.has(target, ["width", "height"]);
        if (degrees === 0) {
          result.x = target.x;
          result.y = target.y;
        } else if (degrees === 90) {
          result.x = size2.height - target.y;
          result.y = target.x;
          if (hasSize)
            result.x -= result.width;
        } else if (degrees === 180) {
          result.x = size2.width - target.x;
          result.y = size2.height - target.y;
          if (hasSize) {
            result.x -= result.width;
    ...
    exports.scale = scale;
    function offset(target, offset2) {
      const result = { ...target };
      result.x += offset2.x;
      result.y += offset2.y;
      return result;
    ...
    function offsetNegative(target, offset2) {
      const result = { ...target };
      result.x -= offset2.x;
      result.y -= offset2.y;
      return result;
    ...
    function isIntersected(region1, region2) {
      return (region1.x <= region2.x ? region2.x < region1.x + region1.width : region1.x < region2.y + region2.width) && (region1.y <= region2.y ? region2.y < region1.y + region1.height : region1.y < region2.y + region2.height);
    }
    exports.isIntersected = isIntersected;
    function contains(region2, locationOrRegion) {
      if (region2.x <= locationOrRegion.x && region2.y <= locationOrRegion.y) {
        if (types6.has(locationOrRegion, ["width", "height"])) {
          return region2.x + region2.width >= locationOrRegion.x + locationOrRegion.width && region2.y + region2.height >= locationOrRegion.y + locationOrRegion.height;
        }
        return true;
      }
      return false;
    ...
    function equals(locationOrSizeOrRegion1, locationOrSizeOrRegion2) {
      if (types6.has(locationOrSizeOrRegion1, ["x", "y", "width", "height"])) {
        if (types6.has(locationOrSizeOrRegion2, ["x", "y", "width", "height"])) {
          return locationOrSizeOrRegion1.x === locationOrSizeOrRegion2.x && locationOrSizeOrRegion1.y === locationOrSizeOrRegion2.y && locationOrSizeOrRegion1.width === locationOrSizeOrRegion2.width && locationOrSizeOrRegion1.height === locationOrSizeOrRegion2.height;
        }
        return false;
      }
      if (types6.has(locationOrSizeOrRegion1, ["x", "y"])) {
        if (types6.has(locationOrSizeOrRegion2, ["x", "y"])) {
          return locationOrSizeOrRegion1.x === locationOrSizeOrRegion2.x && locationOrSizeOrRegion1.y === locationOrSizeOrRegion2.y;
        }
        return false;
      }
      if (types6.has(locationOrSizeOrRegion1, ["width", "height"])) {
        if (types6.has(locationOrSizeOrRegion2, ["width", "height"])) {
          return locationOrSizeOrRegion1.width === locationOrSizeOrRegion2.width && locationOrSizeOrRegion1.height === locationOrSizeOrRegion2.height;
        }
        return false;
      }
      return false;
    ...
    function divide(region2, size2, padding2 = {}) {
      var _a4, _b;
      guard.notNull(region2, { name: "region" });
      guard.notNull(size2, { name: "size" });
      guard.isNumber(size2.width, { name: "size.width", gt: 0 });
      guard.isNumber(size2.height, { name: "size.height", gt: 0 });
      (_a4 = padding2.top) !== null && _a4 !== void 0 ? _a4 : padding2.top = 0;
      (_b = padding2.bottom) !== null && _b !== void 0 ? _b : padding2.bottom = 0;
      const subRegions = [];
      const maxX = region2.x + region2.width;
      const maxY = region2.y + region2.height;
      const stepX = size2.width;
      const stepY = padding2.top + padding2.bottom < size2.height ? size2.height - (padding2.top + padding2.bottom) : size2.height;
      let currentY = region2.y;
      while (currentY < maxY) {
        let nextY = Math.min(currentY + stepY, maxY);
        if (currentY === region2.y)
          nextY += padding2.top;
        else if (nextY < maxY && nextY + padding2.top >= maxY)
          nextY = maxY;
        const currentHeight = nextY - currentY;
        let currentX = region2.x;
        while (currentX < maxX) {
    ...
    function padding(region2, padding2) {
      var _a4, _b, _c, _d2, _e, _f;
      if (types6.isNumber(padding2)) {
        padding2 = { left: padding2, right: padding2, top: padding2, bottom: padding2 };
      }
      region2.x -= (_a4 = padding2.left) !== null && _a4 !== void 0 ? _a4 : 0;
      region2.width += ((_b = padding2.left) !== null && _b !== void 0 ? _b : 0) + ((_c = padding2.right) !== null && _c !== void 0 ? _c : 0);
      region2.y -= (_d2 = padding2.top) !== null && _d2 !== void 0 ? _d2 : 0;
      region2.height += ((_e = padding2.top) !== null && _e !== void 0 ? _e : 0) + ((_f = padding2.bottom) !== null && _f !== void 0 ? _f : 0);
      return region2;
    }
...
// ../utils/dist/promises.js
var require_promises = __commonJS({
  "../utils/dist/promises.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../utils/dist/queues.js
var require_queues = __commonJS({
  "../utils/dist/queues.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    var promises = __importStar(require_promises());
    var types6 = __importStar(require_types());
    var pause = Symbol("queue pause");
    function makeCorkableQueue(options) {
        ...
        const handle = {
          ...
          async start() {
            ...
            try {
              ...
              if (handle.running || !types6.instanceOf(error, "AbortError"))
      ...
      function cork() {
        if (corked)
          return;
        corked = true;
        Array.from(handles.values()).slice(1).forEach((handle) => handle.abort());
      }
      function uncork() {
        if (!corked)
          return;
  ...
  "../utils/dist/math.js"(exports) {
    ...
    function multiplier(number, error = 0) {
      ...
      while (true) {
        ...
        const [, denominator] = coefficients.reduceRight(([numerator, denominator2], coefficient) => [denominator2 + numerator * coefficient, numerator], [1, 0]);
...
// ../utils/dist/streams.js
var require_streams2 = __commonJS({
  "../utils/dist/streams.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    var buffer_1 = require("buffer");
    var general3 = __importStar(require_general());
    ...
    function persist(stream) {
      const clone2 = stream.pipe(new stream_1.PassThrough());
      let buffer;
      clone2.pipe = general3.wrap(clone2.pipe.bind(clone2), (pipe, destination, options) => {
        if (!buffer) {
          buffer = toBuffer(clone2);
...
// ../utils/dist/process.js
var require_process = __commonJS({
  "../utils/dist/process.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function executeAndControlProcess(command, args = [], options) {
      ...
      const exitPromise = new Promise((resolve, reject) => {
        subProcess.on("error", reject).on("close", (exitCode, signal) => exitCode === 0 ? resolve({ exitCode, stdout, stderr }) : signal ? reject(makeError(new Error(`process exited due to signal ${signal} executing process ${command} with args ${JSON.stringify(args)}`), {
          signal,
          stdout,
          stderr
        ...
        let stdout = subProcess.stdout ? "" : void 0;
        let stderr = subProcess.stderr ? "" : void 0;
...
// ../utils/dist/config.js
var require_config = __commonJS({
  "../utils/dist/config.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    function getConfig({ baseDir = process.cwd(), paths = ["applitools.config.cjs", "applitools.config.js", "eyes.config.js", "eyes.json"], params = [], traverse = { stopDir: os.homedir() }, strict, logger } = {}) {
      const envPath = general3.getEnvValue("CONFIG_PATH");
      if (envPath) {
        traverse = false;
        strict = true;
        if (fs2.statSync(envPath).isDirectory()) {
          baseDir = envPath;
        } else {
          paths = [general3.getEnvValue("CONFIG_PATH")];
        }
      }
      const searchedPaths = [];
      let priorityPath;
      ...
      params.forEach((param) => {
        const value = general3.getEnvValue(param.replace(/(.)([A-Z])/g, "$1_$2").toUpperCase());
        if (!types6.isNotDefined(value)) {
...
var require_dist = __commonJS({
  "../utils/dist/index.js"(exports) {
    ...
    exports.general = __importStar(require_general());
    exports.geometry = __importStar(require_geometry());
    ...
    exports.streams = __importStar(require_streams2());
    exports.process = __importStar(require_process());
    exports.config = __importStar(require_config());
  }
});
...
var require_promisify = __commonJS({
  "../../node_modules/agent-base/dist/src/promisify.js"(exports) {
    ...
    function promisify2(fn) {
      return function(req2, opts) {
        return new Promise((resolve, reject) => {
          fn.call(this, req2, opts, (err, rtn) => {
            if (err) {
              reject(err);
            } else {
              resolve(rtn);
      ...
      class Agent extends events_1.EventEmitter {
        ...
        addRequest(req2, _opts) {
          ...
          const onsocket = (socket) => {
            ...
            const err = new Error(`no Duplex stream was returned to agent-base for \`${req2.method} ${req2.path}\``);
            onerror(err);
          };
          ...
          try {
            debug("Resolving socket for %o request: %o", opts.protocol, `${req2.method} ${req2.path}`);
            Promise.resolve(this.promisifiedCallback(req2, opts)).then(onsocket, callbackError);
          } catch (err) {
    ...
    var HttpProxyAgent = class extends agent_base_1.Agent {
      ...
      callback(req2, opts) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const parsed = url_1.default.parse(req2.path);
          if (!parsed.protocol) {
          ...
          req2.path = url_1.default.format(parsed);
          if (proxy.auth) {
            req2.setHeader("Proxy-Authorization", `Basic ${Buffer.from(proxy.auth).toString("base64")}`);
          }
          let socket;
          if (secureProxy) {
          ...
          if (req2._header) {
            ...
            if (req2.output && req2.output.length > 0) {
              debug("Patching connection write() output buffer with updated header");
              first = req2.output[0];
              endOfHeaders = first.indexOf("\r\n\r\n") + 4;
              req2.output[0] = req2._header + first.substring(endOfHeaders);
              debug("Output buffer: %o", req2.output);
            } else if (req2.outputData && req2.outputData.length > 0) {
              debug("Patching connection write() output buffer with updated header");
              first = req2.outputData[0].data;
              endOfHeaders = first.indexOf("\r\n\r\n") + 4;
              req2.outputData[0].data = req2._header + first.substring(endOfHeaders);
              debug("Output buffer: %o", req2.outputData[0].data);
            }
          }
...
var utils = __toESM(require_dist(), 1);
var dnsCache = {};
async function lookup(hostname, options, callback) {
  try {
    if (!dnsCache[hostname]) {
      dnsCache[hostname] = await import_dns.promises.lookup(hostname, options);
    }
...
var lookupWithCache = lookup;

// dist/agent.js
var import_http_proxy_agent = __toESM(require_dist3(), 1);
var import_https_proxy_agent = __toESM(require_dist4(), 1);
var utils2 = __toESM(require_dist(), 1);
function makeAgent({ proxy, useDnsCache, keepAliveOptions }) {
  return function agent(url) {
    var _a4, _b;
    const proxyOptions = utils2.types.isFunction(proxy) ? proxy(url) : proxy;
    const lookup2 = useDnsCache ? lookupWithCache : void 0;
    if (proxyOptions) {
      const proxyUrl = new URL(proxyOptions.url);
      proxyUrl.username = (_a4 = proxyOptions.username) !== null && _a4 !== void 0 ? _a4 : proxyUrl.username;
      proxyUrl.password = (_b = proxyOptions.password) !== null && _b !== void 0 ? _b : proxyUrl.password;
      const options = { ...(0, import_url.parse)(proxyUrl.href), rejectUnauthorized: false, lookup: lookup2 };
      if (url.protocol === "https:") {
        const agent2 = (0, import_https_proxy_agent.default)(options);
        agent2.callback = utils2.general.wrap(agent2.callback.bind(agent2), (fn, request, options2, ...rest) => {
          return fn(request, { ...options2, rejectUnauthorized: false }, ...rest);
        });
        return agent2;
      } else if (url.protocol === "http:") {
        return (0, import_http_proxy_agent.default)(options);
      }
    } else if (url.protocol === "https:") {
      return new import_https.Agent({ rejectUnauthorized: false, lookup: lookup2, ...keepAliveOptions });
    } else if (url.protocol === "http:") {
      return new import_http.Agent({ lookup: lookup2, ...keepAliveOptions });
    }
  };
}
...
// dist/req.js
var utils3 = __toESM(require_dist(), 1);
...
async function req(input, ...requestOptions) {
  ...
  let abortCode;
  if (options.hooks)
    options.hooks = utils3.types.isArray(options.hooks) ? options.hooks : [options.hooks];
  if (options.retry)
    options.retry = utils3.types.isArray(options.retry) ? options.retry : [options.retry];
  if (options.headers)
    options.headers = Object.fromEntries(Object.entries(options.headers).filter(([_, value]) => value));
  const connectionController = new import_abort_controller.AbortController();
  ...
  try {
    return await req2(input, options);
  } finally {
    if (connectionTimer)
      clearTimeout(connectionTimer);
  }
  async function req2(input2, options2) {
    var _a4, _b, _c, _d2, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
    const url = new URL(String((_a4 = input2.url) !== null && _a4 !== void 0 ? _a4 : input2), options2.baseUrl);
    const fetch2 = (_b = options2.fetch) !== null && _b !== void 0 ? _b : fetch;
    let optionsFallbacks = [];
    if (options2.fallbacks)
      optionsFallbacks = utils3.types.isArray(options2.fallbacks) ? options2.fallbacks : [options2.fallbacks];
    const fb = optionsFallbacks.find((fallback) => {
      var _a5;
      return (_a5 = fallback.cache) === null || _a5 === void 0 ? void 0 : _a5.get(url.origin);
    });
    if (fb === null || fb === void 0 ? void 0 : fb.updateOptions)
      options2 = await fb.updateOptions({ options: options2 });
    const requestController = new import_abort_controller.AbortController();
    ...
    if (options2.query) {
      Object.entries(options2.query).forEach(([key, value]) => {
        if (!utils3.types.isNull(value))
          url.searchParams.set(key, String(value));
      });
    }
    const extraHeaders = {};
    if (utils3.types.isPlainObject(options2.body) || utils3.types.isArray(options2.body) || options2.body === null) {
    ...
    let request = new Request(url, {
      ...
      headers: {
        ...extraHeaders,
        ...Object.fromEntries((_e = (_d2 = input2.headers) === null || _d2 === void 0 ? void 0 : _d2.entries()) !== null && _e !== void 0 ? _e : []),
    ...
    try {
      ...
      if (!response.ok && optionsFallbacks.length > 0) {
        ...
        if (fallbackOptions) {
          const fallbackStrategyResponse = await req2(request, fallbackOptions);
      ...
      const retry = await ((_j = options2.retry) === null || _j === void 0 ? void 0 : _j.reduce(async (prev, retry2) => {
        ...
        return result !== null && result !== void 0 ? result : (((_a5 = retry2.statuses) === null || _a5 === void 0 ? void 0 : _a5.includes(response.status)) || await ((_b2 = retry2.validate) === null || _b2 === void 0 ? void 0 : _b2.call(retry2, { response }))) && (!retry2.limit || !retry2.attempt || retry2.attempt < retry2.limit) ? retry2 : null;
      }, Promise.resolve(null)));
      if (retry) {
        (_k = retry.attempt) !== null && _k !== void 0 ? _k : retry.attempt = 0;
        const delay = response.headers.has("Retry-After") ? Number(response.headers.get("Retry-After")) * 1e3 : utils3.types.isArray(retry.timeout) ? retry.timeout[Math.min(retry.attempt, retry.timeout.length - 1)] : (_l = retry.timeout) !== null && _l !== void 0 ? _l : 0;
        await utils3.general.sleep(delay);
        retry.attempt += 1;
        const retryRequest = await beforeRetry({ request, response, attempt: retry.attempt, stop, options: options2 });
        if (retryRequest !== stop) {
          return req2(retryRequest, options2);
        }
      }
      ...
      const retry = await ((_m = options2.retry) === null || _m === void 0 ? void 0 : _m.reduce((prev, retry2) => {
        return prev.then(async (result) => {
          var _a5, _b2;
          return (result !== null && result !== void 0 ? result : (((_a5 = retry2.codes) === null || _a5 === void 0 ? void 0 : _a5.includes(error.code)) || await ((_b2 = retry2.validate) === null || _b2 === void 0 ? void 0 : _b2.call(retry2, { error }))) && (!retry2.limit || !retry2.attempt || retry2.attempt < retry2.limit)) ? retry2 : null;
        });
      }, Promise.resolve(null)));
      if (retry) {
        (_o = retry.attempt) !== null && _o !== void 0 ? _o : retry.attempt = 0;
        const delay = utils3.types.isArray(retry.timeout) ? retry.timeout[Math.min(retry.attempt, retry.timeout.length)] : (_p = retry.timeout) !== null && _p !== void 0 ? _p : 0;
        await utils3.general.sleep(delay);
...
function mergeOptions(baseOptions, ...options) {
  var _a4;
  const mergedOptions = options.reduce((baseOptions2, options2) => ({
    ...baseOptions2,
    ...options2,
    query: { ...baseOptions2.query, ...options2 === null || options2 === void 0 ? void 0 : options2.query },
    headers: { ...baseOptions2.headers, ...options2 === null || options2 === void 0 ? void 0 : options2.headers },
    retry: [
      ...baseOptions2.retry ? [].concat(baseOptions2.retry) : [],
      ...(options2 === null || options2 === void 0 ? void 0 : options2.retry) ? [].concat(options2.retry) : []
    ],
    hooks: [
      ...baseOptions2.hooks ? [].concat(baseOptions2.hooks) : [],
      ...(options2 === null || options2 === void 0 ? void 0 : options2.hooks) ? [].concat(options2.hooks) : []
    ],
    fallbacks: [
      ...baseOptions2.fallbacks ? [].concat(baseOptions2.fallbacks) : [],
      ...(options2 === null || options2 === void 0 ? void 0 : options2.fallbacks) ? [].concat(options2.fallbacks) : []
    ]
  }), baseOptions);
  return ((_a4 = mergedOptions.hooks) !== null && _a4 !== void 0 ? _a4 : []).reduce((options2, hooks) => {
    var _a5, _b;
    return (_b = (_a5 = hooks.afterOptionsMerged) === null || _a5 === void 0 ? void 0 : _a5.call(hooks, { options: options2 })) !== null && _b !== void 0 ? _b : options2;
  }, mergedOptions);
}
function beforeRequest({ request, options, ...rest }) {
  var _a4;
  return ((_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : []).reduce(async (request2, hooks) => {
    var _a5, _b;
    request2 = await request2;
    const result = await ((_a5 = hooks.beforeRequest) === null || _a5 === void 0 ? void 0 : _a5.call(hooks, { request: request2, options, ...rest }));
    if (!result)
      return request2;
    else if (utils3.types.instanceOf(result, Request))
      return result;
    else if (utils3.types.has(result, "url"))
...
function beforeRetry({ request, options, ...rest }) {
  ...
  return ((_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : []).reduce(async (request2, hooks) => {
    ...
    if (request2 === stop)
      return request2;
    const result = await ((_a5 = hooks.beforeRetry) === null || _a5 === void 0 ? void 0 : _a5.call(hooks, { request: request2, options, ...rest }));
    if (result === stop)
      return result;
    else if (!result)
      return request2;
...
function afterResponse({ response, options, ...rest }) {
  var _a4, _b;
  return (_b = (_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : []) === null || _b === void 0 ? void 0 : _b.reduce(async (response2, hooks) => {
    var _a5, _b2, _c, _d2;
    response2 = await response2;
    const result = await ((_a5 = hooks.afterResponse) === null || _a5 === void 0 ? void 0 : _a5.call(hooks, { response: response2, options, ...rest }));
    if (!result)
      return response2;
    else if (utils3.types.instanceOf(result, Response))
      return result;
    else
      return new Response((_b2 = result.body) !== null && _b2 !== void 0 ? _b2 : (_c = result.response) === null || _c === void 0 ? void 0 : _c.body, (_d2 = result.response) !== null && _d2 !== void 0 ? _d2 : result);
  }, response);
}
function afterError({ error, options, ...rest }) {
  var _a4, _b;
  return (_b = (_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : []) === null || _b === void 0 ? void 0 : _b.reduce(async (error2, hooks) => {
    var _a5;
    error2 = await error2;
    return await ((_a5 = hooks.afterError) === null || _a5 === void 0 ? void 0 : _a5.call(hooks, { error: error2, options, ...rest })) || error2;
  }, error);
}
